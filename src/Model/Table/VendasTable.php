...
class VendasTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('responsavel_vend')
            ->maxLength('responsavel_vend', 100)
            ->requirePresence('responsavel_vend', 'create')
            ->notEmptyString('responsavel_vend');
        ...
        $validator
            ->integer('qtde_venda')
            ->requirePresence('qtde_venda', 'create')
            ->notEmptyString('qtde_venda');

        $validator
            ->numeric('total_venda')
            ->requirePresence('total_venda', 'create')
            ->notEmptyString('total_venda');
